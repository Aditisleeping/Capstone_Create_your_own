...
data <- read.csv("https://raw.githubusercontent.com/Aditisleeping/Capstone_Create_your_own/main/dataset.csv")
...
plot_num(dplyr::select(data,-id), bins=10) 
...
data2 <- dplyr::select(data,-highlyCorrelated)
...
set.seed(1815, sample.kind="Rounding") #provare 1234
